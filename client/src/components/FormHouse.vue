                      ...
                      <el-col :span="20">
                        <el-form ref="ruleForm2" label-width="200px" class="demo-ruleForm">
                          ...
                          <el-form-item label="Longitut" prop="age">
                            <el-input type="text" v-model="house_data.location.long"></el-input>
                          </el-form-item>
                          <el-form-item label="Langintut" prop="age">
                            <el-input type="text" v-model="house_data.location.lat"></el-input>
                          </el-form-item>
